...
/*
 * on enable  - on before render event - gives us smoothest result for when we are actually moving the string
 * ensures it is rendered before we are moving any of our vr stuff
 *
 * every frame
 *
 * pull gradient changes colour
 */
