...
{
    /*
     * Detects when player is trying to interact with the string
     * 
     * when is being pulled:
     * track the interactor,
     * figure out what direction its pulling in
     * check if direction is valid.
     *
     * custom pull event lets other things know when the string is being pulled back on
     *
     * pull strength 0-1
     * 
     */
